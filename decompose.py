...
Отвечай на том же языке, на котором в основном написан запрос пользователя. Если запрос в основном на русском — весь ответ (analysis, composer_queries) на русском. Если на английском — на английском. Исключение: если в запросе явно указан другой язык («ответь на английском», «respond in Russian» и т.п.) — следуй указанию.
