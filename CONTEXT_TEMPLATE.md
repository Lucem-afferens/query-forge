...
Укажи реальные пути. Composer/Agent использует @Folders — даёт путь и обзор содержимого.
...
Файлы, которые стоит явно @-упоминать в подзапросе. Composer/Agent читает их целиком (или конденсирует, если большие).
