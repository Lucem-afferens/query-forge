...
**Суть:** пишешь запрос по-человечески — получаешь готовые подзапросы для Cursor Composer. Composer лучше работает с чёткими шагами, а не с размытым «сделай всё». QueryForge разбивает твой запрос на понятные подзадачи с контекстом и критериями готовности.
